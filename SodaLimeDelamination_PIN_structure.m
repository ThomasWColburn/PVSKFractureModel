...
clear;
% PVSK on Soda Lime Glass substrate %
...
b(1).CData(4,:) = [0.6350 0.0780 0.1840]; % group 4 1st bar

b(2).CData(1,:) = [0.5 0.5 0.5]; % group 1 2nd bar
b(2).CData(2,:) = [0 0.4470 0.7410]; % group 2 2nd bar
b(2).CData(3,:) = [0.8500 0.3250 0.0980]; % group 3 2nd bar
b(2).CData(4,:) = [0.6350 0.0780 0.1840]; % group 4 2nd bar

b(3).CData(1,:) = [0.5 0.5 0.5]; % group 1 3rd bar
b(3).CData(2,:) = [0 0.4470 0.7410]; % group 2 3rd bar
b(3).CData(3,:) = [0.8500 0.3250 0.0980]; % group 3 3rd bar
b(3).CData(4,:) = [0.6350 0.0780 0.1840]; % group 4 3rd bar
...
%% Make figures of hc for ITO, NiOx, PVSK for PIN, evap and screen-printed
...
figure;
x = [hc_PVSKRSPP_evap*10^9 hc_NiO_NiOITO_evap_PVSKRSPP*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9; ...
    hc_PVSKhotcast_evap*10^9 hc_NiO_NiOITO_evap_PVSKhotcast*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9;...
    hc_PVSKspincoat_evap*10^9 hc_NiO_NiOITO_evap_PVSKspincoat*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
...
legend("PVSK", "NiOx", "ITO");

b(1).CData(1,:) = [0.8500 0.3250 0.0980]; % group 1 1st bar
b(1).CData(2,:) = [0.8500 0.3250 0.0980]; % group 2 1st bar
b(1).CData(3,:) = [0.8500 0.3250 0.0980]; % group 3 1st bar

b(2).CData(1,:) = [0.4660 0.6740 0.1880]; % group 1 2nd bar
b(2).CData(2,:) = [0.4660 0.6740 0.1880]; % group 2 2nd bar
b(2).CData(3,:) = [0.4660 0.6740 0.1880]; % group 3 2nd bar
...
figure;
x = [hc_PVSKRSPP_screen*10^9 hc_NiO_NiOITO_screen_PVSKRSPP*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9; ...
    hc_PVSKhotcast_screen*10^9 hc_NiO_NiOITO_screen_PVSKhotcast*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9;...
    hc_PVSKspincoat_screen*10^9 hc_NiO_NiOITO_screen_PVSKspincoat*10^9 hc_ITOglass_buckle_sodaLimeGlass*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
set(gca, 'XTick', xt, 'XTickLabel', {'RSPP PVSK', 'Hotcast PVSK', 'Spincoat PVSK'})
set(gca,'YScale','log')
