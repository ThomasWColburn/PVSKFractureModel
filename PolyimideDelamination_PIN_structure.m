...
b(1).CData(1,:) = [0.345 0.176 0.419]; % group 1 1st bar
b(1).CData(2,:) = [0.2 0.094 0.090]; % group 2 1st bar
b(1).CData(3,:) = [0.392 0.560 0.333]; % group 3 1st bar

b(2).CData(1,:) = [0.345 0.176 0.419]; % group 1 2nd bar
b(2).CData(2,:) = [0.2 0.094 0.090]; % group 2 2nd bar
b(2).CData(3,:) = [0.392 0.560 0.333]; % group 3 2nd bar

b(3).CData(1,:) = [0.345 0.176 0.419]; % group 1 3rd bar
b(3).CData(2,:) = [0.2 0.094 0.090]; % group 2 3rd bar
b(3).CData(3,:) = [0.392 0.560 0.333]; % group 3 3rd bar
