...
figure;
x = [hc_PVSKRSPP_evap*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9; ...
    hc_PVSKhotcast_evap*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9;...
    hc_PVSKspincoat_evap*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
...
figure;
x = [hc_PVSKRSPP_screen*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9; ...
    hc_PVSKhotcast_screen*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9;...
    hc_PVSKspincoat_screen*10^9 hc_NiO_buckle_polyimide*10^9 hc_ITOglass_buckle_polyimide*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
set(gca, 'XTick', xt, 'XTickLabel', {'RSPP PVSK', 'Hotcast PVSK', 'Spincoat PVSK'})
set(gca,'YScale','log')
