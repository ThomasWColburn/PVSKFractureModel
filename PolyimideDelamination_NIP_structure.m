...
sigma_Au_screen = (a_Au_screen - a_Polyimide)*delta_T_Au_screen*E_Au_screen;
...
% Define the height of the screen-printed Au (layer not being varied)
h_Au_screen = 1000e-9;
...
% Set the "default" heights of PVSK and Au screen, the heights of the
...
hc_Au_screen_PVSKRSPP_values = [hc_AuScreenBucklePI; hc_AuScreen_SpiroPVSK; ...
...
hc_Au_screen_PVSKhotcast_values = [hc_AuScreenBucklePI; hc_AuScreen_SpiroPVSK;...
...
hc_Au_screen_PVSKspincoat_values = [hc_AuScreenBucklePI; hc_AuScreen_SpiroPVSK;...
...
figure;
x = [hc_Au_screen_PVSKRSPP*10^9 hc_Au_screen_PVSKhotcast*10^9 hc_Au_screen_PVSKspincoat*10^9; ...
...
figure;
x = [hc_PVSKRSPP_evap*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9; ...
    hc_PVSKhotcast_evap*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9;...
    hc_PVSKspincoat_evap*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
...
figure;
x = [hc_PVSKRSPP_screen*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9; ...
    hc_PVSKhotcast_screen*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9;...
    hc_PVSKspincoat_screen*10^9 hc_SnOx_buckle_PI*10^9 hc_ITOglass_buckle_PI*10^9];
b = bar(x, 'FaceColor', 'flat');
xt = get(gca, 'XTick');
set(gca, 'XTick', xt, 'XTickLabel', {'RSPP PVSK', 'Hotcast PVSK', 'Spincoat PVSK'})
set(gca,'YScale','log')
ylabel('Critical Debond Thickness h_c, (nm)')
title("Polyimide substrate, NIP, screen-printed Au", 'FontWeight','Normal')
box on;
set(gca, 'FontSize', 14, 'FontName', 'Arial');
% Determine the y-axis limits to use in the bar plot.
y_lowerlimit = (min(min(x))+1)/10;
